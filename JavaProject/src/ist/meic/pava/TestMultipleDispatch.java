...
import ist.meic.pava.tests.baseVersionTests.ExampleClass;
import ist.meic.pava.tests.extendedVersionTests.ExampleClassExtended;
...
//        compareTestResults(outputFile);
    ...
    public static File setErrorOutputFile() {
        File file = new File("test_files/test_results.txt");
    ...
    public static void compareTestResults(File outputFile) {
        File expectedResults = new File("test_files/expected_results.txt");
